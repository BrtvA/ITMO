...
namespace ITMO.ADO.Lab5.ex1.DataSourcesWizard.NorthwindDataSetTableAdapters {
...
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ITMO.ADO.Lab5.ex1.DataSourcesWizard.Properties.Settings.Default.NorthwindConnectionString;
        }
