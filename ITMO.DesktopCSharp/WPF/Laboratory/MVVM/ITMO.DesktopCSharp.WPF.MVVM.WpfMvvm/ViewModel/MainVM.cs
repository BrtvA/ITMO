...
namespace ITMO.DesktopCSharp.WPF.MVVM.WpfMvvm.ViewModel
{
    internal class MainVM : INotifyPropertyChanged
    {
        ...
        // public int Number3 { get; } => MathFuncs.GetSumOf(Number1, Number2); // C#6.0
        public int Number3
        {
            get
            {
                return Model.MathFuncs.GetSumOf(Number1, Number2);
            }
        }
    }
}
