...
public class IntMathematics implements IMathematics<Integer> {
    @Override
    public Integer[][] transposeMatrix(Integer[][] matrix) {
        int rows = matrix.length;
        int columns = matrix[0].length;

        Integer[][] transposedMatrix = new Integer[columns][rows];
    ...
    @Override
    public Integer[][] multiplyMatrices(Integer[][] matrixA, Integer[][] matrixB) {
        Integer[][] result = new Integer[matrixA.length][matrixB[0].length];
    ...
    @Override
    public Integer[][] multiplyMatricesParallel(Integer[][] matrixA, Integer[][] matrixB, int threadCount) {
        Integer[][] result = new Integer[matrixA.length][matrixB[0].length];
    ...
    @Override
    public Integer[][] addMatrices(Integer[][] matrixA, Integer[][] matrixB) {
        for (int row = 0; row < matrixA.length; row++) {
    ...
    @Override
    public Integer[][] multiplyByScalar(Integer[][] matrix, Integer scalar) {
